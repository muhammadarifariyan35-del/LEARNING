...
let num = 30.6664565;
console.log(Math.round(num)); /// রাউন্ড করতে চাইলে। হয়তো উপরে উঠবে নয়তো নিচে নামবে। মানে তার কাছাকাছি নাম্বারে যাবে। //? আনুপাতিক
...
const r = 56967;
console.log(r.toPrecision(6));  /// এটা বলে: “আমাকে পুরো সংখ্যাটা (decimal সহ) মোট কয়টা ডিজিটে দেখাতে হবে।”  this nor recomendetl
